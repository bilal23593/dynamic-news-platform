...
const storyBlueprints = [
  {
    ...
    tagSlugs: ["budget", "traffic", "public safety"],
    featured: true,
    trending: true,
    breakingNews: true,
    popular: true,
  ...
  },
  {
    ...
    tagSlugs: ["development", "housing", "traffic"],
    featured: true,
    imageUrl:
      "https://images.unsplash.com/photo-1460317442991-0ec209397118?auto=format&fit=crop&w=1200&q=80",
  },
  {
    ...
    tagSlugs: ["college sports", "consumer"],
    trending: true,
    popular: true,
  ...
  },
  {
    ...
    tagSlugs: ["storm alert", "traffic", "health"],
    breakingNews: true,
    trending: true,
    popular: true,
  ...
  },
  {
    ...
    subCategorySlug: "falcons",
    authorSlug: "evan-carter",
    tagSlugs: ["college sports", "consumer", "development"],
    imageUrl:
  ...
  },
  {
    ...
    subCategorySlug: "elections",
    authorSlug: "jordan-blake",
    tagSlugs: ["election 2026", "schools"],
    imageUrl:
  ...
  },
  {
    ...
    subCategorySlug: "data-desk",
    authorSlug: "naomi-pierce",
    tagSlugs: ["housing", "consumer", "accountability"],
    imageUrl:
  ...
  },
  {
    ...
    subCategorySlug: "real-estate",
    authorSlug: "marcus-hill",
    tagSlugs: ["housing", "storm alert", "consumer"],
    imageUrl:
  ...
  },
  {
    ...
    subCategorySlug: "braves",
    authorSlug: "evan-carter",
    tagSlugs: ["consumer", "college sports"],
    imageUrl:
...
export const demoHomepageSections: Array<{
  ...
  },
  {
    ...
    sourceType: "MANUAL",
    limit: 5,
    manualArticleSlugs: demoArticles.slice(16, 21).map((story) => story.slug),
    settings: {
      eyebrow: "National",
      layout: "dense",
      viewAllHref: "/news",
  ...
  },
  {
    ...
    sourceType: "MANUAL",
    limit: 4,
    manualArticleSlugs: demoArticles.slice(8, 12).map((story) => story.slug),
    settings: {
      eyebrow: "Shows",
      layout: "dense",
  ...
  },
  {
    ...
    sourceType: "MANUAL",
    limit: 3,
    manualArticleSlugs: demoArticles.slice(4, 7).map((story) => story.slug),
    settings: {
      eyebrow: "Seen on TV",
      layout: "compact",
  ...
  },
  {
    ...
    sourceType: "MANUAL",
    limit: 4,
    manualArticleSlugs: demoArticles.slice(12, 16).map((story) => story.slug),
    settings: {
      eyebrow: "Guide",
      layout: "compact",
